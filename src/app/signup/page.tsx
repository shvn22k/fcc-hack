          ...
          <div className="w-full max-w-md rounded-2xl shadow-2xl border border-white/10 bg-black/60 backdrop-blur-lg p-8">
            ...
            <form className="space-y-5">
              <div>
                ...
                <input type="text" id="name" className="w-full px-4 py-2 rounded-lg bg-white/10 text-white font-secondary border border-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="Your Name" required />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="password" id="confirm" className="w-full px-4 py-2 rounded-lg bg-white/10 text-white font-secondary border border-white/10 focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="••••••••" required />
              </div>
              <button type="submit" className="w-full py-3 rounded-lg bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold font-secondary text-lg shadow-lg hover:from-purple-600 hover:to-pink-600 transition-all">Sign Up</button>
            </form>
